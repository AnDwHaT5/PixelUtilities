...
public class RubyHammerTool extends ItemHammer{

	String iconString;


	public RubyHammerTool(ToolMaterial par3EnumToolMaterial, String iconString, String itemName) {
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("pixelutilitys:" + "RubyHammer");
	}
