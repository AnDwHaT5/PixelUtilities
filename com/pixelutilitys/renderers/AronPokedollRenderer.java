...
public class AronPokedollRenderer extends TileEntitySpecialRenderer{
	...
	AronPokedollModel model = new AronPokedollModel();

	private static final ResourceLocation field_110422_t = new ResourceLocation("pixelutilitys:textures/specialmodels/AronDoll.png"); 
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
		...
		this.model.render((Entity)null, 0.0F, 0.0F, -0.1F, .5F, 0.0F, 0.0700F);
		GL11.glPopMatrix();
	}
