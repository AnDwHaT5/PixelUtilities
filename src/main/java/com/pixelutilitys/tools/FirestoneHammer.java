...
public class FirestoneHammer extends ItemHammer{

	String iconString;


	public FirestoneHammer(ToolMaterial par3EnumToolMaterial, String iconString,
			String itemName) {
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("pixelutilitys:" + "FirestoneHammer");
	}
