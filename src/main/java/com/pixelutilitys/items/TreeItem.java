        ...
        public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10){
    		if(par7 != 1){
    			...
    			if(player.canPlayerEdit(x, y + 1, z, par7, stack) && player.canPlayerEdit(x, y + 2, z, par7, stack)){
    				world.setBlock(x, y + 1, z, PixelUtilitysBlocks.TreeBlock);
   
    				world.notifyBlockOfNeighborChange(x, y + 1, z, PixelUtilitysBlocks.TreeBlock);
